...
public class HelpWindowController implements Initializable {
	...
	public void initialize(URL url, ResourceBundle rb) {
		cpuImage.setImage(new Image(getClass().getResourceAsStream("/sk/catheaven/icons/cpu.png")));	// Icon made by <a href="https://www.flaticon.com/authors/nhor-phai" title="Nhor Phai">Nhor Phai</a> from <a href="https://www.flaticon.com/" title="Flaticon"> www.flaticon.com</a>
	}
